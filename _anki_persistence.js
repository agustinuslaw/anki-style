...
if (void 0 === window.Persistence) {
  ...
  if (
    ((window.Persistence_sessionStorage = function () {
      ...
      try {
        'object' == typeof window.sessionStorage &&
          ((e = !0), (this.clear = function () {
            ...
            void 0 == t &&
              ((t = e), (e = _defaultKey)), sessionStorage.setItem (
              _persistenceKey + e,
              JSON.stringify (t)
            );
          }), (this.getItem = function (e) {
            return void 0 == e && (e = _defaultKey), JSON.parse (
              sessionStorage.getItem (_persistenceKey + e)
            );
          }), (this.removeItem = function (e) {
            void 0 == e && (e = _defaultKey), sessionStorage.removeItem (
              _persistenceKey + e
            );
          }));
      } catch (e) {}
      ...
      var t = window[e], i = !1;
      'object' == typeof t &&
        ((i = !0), (this.clear = function () {
          t[_persistenceKey] = {};
        }), (this.setItem = function (e, i) {
          void 0 == i && ((i = e), (e = _defaultKey)), (t[_persistenceKey][
            e
          ] = i);
        }), (this.getItem = function (e) {
          return void 0 == e && (e = _defaultKey), t[_persistenceKey][e] ||
            null;
        }), (this.removeItem = function (e) {
          void 0 == e && (e = _defaultKey), delete t[_persistenceKey][e];
        }), void 0 == t[_persistenceKey] &&
          this.clear ()), (this.isAvailable = function () {
        return i;
      });
    }), (window.Persistence = new Persistence_sessionStorage ()), Persistence.isAvailable () ||
      (window.Persistence = new Persistence_windowKey (
        'py'
